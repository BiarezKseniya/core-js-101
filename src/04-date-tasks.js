...
function timeSpanToString(startDate, endDate) {
  const timespan = Math.abs(endDate - startDate);
  const hours = Math.floor(timespan / 3600000);
  const minutes = Math.floor((timespan - hours * 3600000) / 60000);
  const seconds = ((timespan - hours * 3600000 - minutes * 60000) / 1000).toFixed(3);
...
function angleBetweenClockHands(date) {
  ...
  const angle = Math.abs(Math.PI * (((hours % 12) + minutes / 60
  + seconds / 3600 - (minutes / 5 + seconds / 300)) / 6));
